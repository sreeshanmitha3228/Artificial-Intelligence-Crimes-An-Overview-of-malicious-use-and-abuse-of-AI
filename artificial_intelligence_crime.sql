...
--
-- Host: localhost
-- Generation Time: Jan 24, 2023 at 10:45 AM
...
--
-- Database: `artificial_intelligence_crime`
--
CREATE DATABASE IF NOT EXISTS `artificial_intelligence_crime` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `artificial_intelligence_crime`;
...
('bapsoyz1i20ji0ohphgoxg0gcq5rjojl', 'eyJ1c2VyaWQiOjJ9:1pIpDU:ws7xybuBCxqbO8D9RwDohYGg_bUGVnfQDq90WFlf03s', '2023-02-03 11:05:52.349817'),
...
('vfrq2hxiyv5xup5r0y8g0tyyc62o8gkj', 'eyJ1c2VyaWQiOjF9:1pIo6j:CqyJgJPx6i7ql66rj3nSo5lFZCqmjUuitKzYnmji2FI', '2023-02-03 09:54:49.973164'),
...
(1, 'Ramraj', 'Ramraj123@gmail.com', 'Ramraj', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(22, 'Naive Bayes', '38.84514435695538'),
(23, 'Extra Tree Classifier', '35.73928258967629'),
(24, 'SVM', '37.576552930883636'),
(25, 'Logistic Regression', '38.67016622922135'),
(26, 'Decision Tree Classifier', '37.53280839895013');
...
(23, 'Social Engineering', '50.0'),
(24, 'Misinformation', '16.666666666666664'),
(25, 'Hacking', '16.666666666666664'),
(26, 'Autonomous weapon systems', '16.666666666666664');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_prediction_of_crime_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_prediction_of_crime_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `FID` varchar(300) NOT NULL,
  `url` varchar(300) NOT NULL,
  `length_url` varchar(300) NOT NULL,
  `length_hostname` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_prediction_of_crime_type`
--

INSERT INTO `remote_user_prediction_of_crime_type` (`id`, `FID`, `url`, `length_url`, `length_hostname`, `Source_IP`, `Source_Port`, `Destination_IP`, `Destination_Port`, `Prediction`) VALUES
(1, '10.42.0.42-66.198.178.91-57417-443-6', 'https://www.missfiga.com/', '25', '16', '10.42.0.211', '41106', '172.217.3.106', '443', 'Hacking'),
(2, '10.42.0.211-52.84.143.74-51243-80-6', 'http://sophie-world.com/games/port-and-starboard', '48', '16', '10.42.0.151', '34088', '172.217.12.206', '443', 'Social Engineering'),
(3, '172.217.10.78-10.42.0.151-443-57693-6', 'http://www.ktplasmachinery.com/cs/', '34', '23', '10.42.0.211', '47447', '172.217.6.202', '443', 'Social Engineering'),
(4, '172.217.10.74-10.42.0.211-443-33776-6', 'http://www.game.co.uk/en/games/nintendo-switch/nintendo-switch/', '63', '14', '10.42.0.151', '34789', '173.194.175.188', '5228', 'Misinformation'),
(5, '172.217.3.97-10.42.0.42-443-40598-6', 'http://press-preview.weebly.com', '31', '24', '172.217.10.42', '443', '10.42.0.42', '56914', 'Autonomous weapon systems'),
(6, '10.42.0.151-10.42.0.1-5128-53-17', 'http://www.inbioma.pe/rechnung-376440790464490488&amp;cgi3-viewkontakt-376440790464490488-007acctpagetype-376440790464490488=4674720-&amp;info@s-und-s-shop.de.html', '163', '14', '91.190.219.146', '443', '10.42.0.151', '54317', 'Social Engineering');
